    ...
    <div class="main-content">
      <div class="formDiv">
        ...
        <el-form ref="form" :model="form" label-width="0">
          <el-form-item>
            <el-input prefix-icon="el-icon-user" clearable v-model="form.phone" placeholder="手机号码或邮箱"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input prefix-icon="el-icon-lock" clearable v-model="form.password" placeholder="密码" show-password></el-input>
          </el-form-item>
          <el-form-item>
            <el-button class="btn-block" type="primary" @click="fn">登录</el-button>
          </el-form-item>
          <div class="gap">
